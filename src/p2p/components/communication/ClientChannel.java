...
public abstract class ClientChannel extends Channel {
	 ...
	 * request that the client sent to initialize the communication.
	 *
	 * @author {@literal p3100161 <Joseph Sakos>}
	 */
	public enum Status {
	 ...
	 * the {@link Channel#communicate communicate()} method or else it
	 * is going to remain unknown.
	 */
	protected Status status;
	
	/**
	 * Allocates a new ClientChannel object by binding a
	 * {@link Socket} object to server's socket and initializing the
	 * associated streams.
	 *
	 * @param group
	 ...
	 *        The binding should occur or have already been occurred elsewhere.
	 * @throws IOException
	 *         If an error occurs during the allocation of the
