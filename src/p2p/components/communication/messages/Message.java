...
/**
 * A Message is a serializable object that is used by a channel to send data
 * from the local to the remote socket.
 *
...
public class Message<D extends Serializable> implements Serializable {
	...
	/**
	 * Tries to treat the provided object as a Message object and retrieve its
	 * data casted in the expected type.
	 *
	 * @param <D>
	 ...
	 */
	public static <D extends Serializable> D getData(final Object object, final Class<D> expected_type)
	        throws ClassCastException {
	...
	/**
	 * Allocates a new Message object. The data remain <b>mutable</b> after the
	 * construction. The caller is responsible to pass a copy of the data to
	 * ensure their integrity.
	 *
	 * @param data
	 *            The data this message is going to contain.
	 */
	public Message(final D data) {
		
		this.data = data;
	}
	
	/**
	 * Returns the contained data as a <b>mutable</b> object. The caller is
	 * responsible for making a copy the of the data to ensure their integrity.
	 *
